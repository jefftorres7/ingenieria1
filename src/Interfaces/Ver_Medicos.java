 ...
 * @author Jefferson
 */
public class Ver_Medicos extends javax.swing.JInternalFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ver_Medicos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ver_Medicos().setVisible(true);
            }
        });
    }

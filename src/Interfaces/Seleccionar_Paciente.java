 ...
 * @author Jefferson
 */
public class Seleccionar_Paciente extends javax.swing.JInternalFrame {
    ...
    public Seleccionar_Paciente() {
        initComponents();
        btnAceptar.setEnabled(false);
        ((BasicInternalFrameUI) this.getUI()).setNorthPane(null);
        carTablaPacientes("");
         tblPacientesVista.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
    ...
    public void Aceptar(){
         int fila = tblPacientesVista.getSelectedRow();
                if (tblPacientesVista.getSelectedRow() != -1) {
                    Agregar_Cita.pac= tblPacientesVista.getValueAt(fila, 0).toString();
                    Agregar_Cita.txtPacienteCita.setText(tblPacientesVista.getValueAt(fila, 1).toString()+"  "+tblPacientesVista.getValueAt(fila, 2));
//                    Agregar_Cita.areaConfirmacion.setText("PACIENTE: "+" "+tblPacientesVista.getValueAt(fila, 1).toString()+"  "+tblPacientesVista.getValueAt(fila, 2));
                    Agregar_Cita.btnBuscarMedico.setEnabled(true);
                    Agregar_Cita.txtMmedico.setEnabled(true);
                }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Seleccionar_Paciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Seleccionar_Paciente().setVisible(true);
            }
        });
    }

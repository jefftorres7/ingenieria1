...
public class AgregarServicio extends javax.swing.JInternalFrame {
    ...
    public void Guardar() {
        ...
        if ("".equals(Nombre) || "".equals(Descripcion) || "".equals(PrecioF)) {
            ...
            String sql="";
            sql="INSERT INTO SERVICIOS(COD_SERV,NOM_SERV,PRECIO,DETALLE,ESTADO) VALUES(?,?,?,?,?)";
            try {
                PreparedStatement psd = cn.prepareStatement(sql);
                psd.setString(1, null);
                 psd.setString(2,Nombre);
                  psd.setDouble(3,Precio);
                   psd.setString(4, Descripcion);
                    psd.setInt(5,1);
                 ...
                 JOptionPane.showMessageDialog(this,"Surgio un error al Guardar");
            }
